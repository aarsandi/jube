...
export default function Homepage() {
  ...
  console.log(data.map((data) => data.picture));
            ...
            <div className="collapse navbar-collapse justify-content-between">
              ...
              <ul className="navbar-nav header-right main-notification">
                ...
                <li className="nav-item dropdown header-profile">
                  ...
                  >
                    <img
                      // src={`${process.env.PUBLIC_URL}/assets/images/profile/pic1.jpg`}
                      src={data.map((data) => data.picture.large)}
                      width="20"
                      alt=""
                    />
                    <div className="header-info">
                      <span>
                        {data.map((data) => data.name.first)}{" "}
                        {data.map((data) => data.name.last)}{" "}
                      </span>
          ...
          <div className="row">
            ...
            <div className="deznav">
              <div className="deznav-scroll">
                ...
                <div className="copyright">
                  <p>
                    <strong>Jube Admin Dashboard</strong> © 2021 All Rights
                    Reserved
                  </p>
                  <p className="fs-12">
